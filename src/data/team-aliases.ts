...
export const TEAM_ALIASES: Record<string, string> = {
  ...
  arnavutkoybelediyesifutbolsk: 'Arnavutköy Belediyesi FSK',
  batmanpetrolsporas: 'Batman Petrolspor',
  beykozanadolusporas: 'Beykoz Anadolu Spor',
  beyogluyenicarsisporfaaliyetlerias: 'Beyoğlu Yeni Çarşı Spor',
  ...
  hatayspor: 'Hatayspor',
  isparta32sporkulubu: 'Isparta 32 Spor Kulübü',
  ...
  sebatgenclikspor: 'Sebat Gençlik Spor',
  somaspor: 'Somaspor',
