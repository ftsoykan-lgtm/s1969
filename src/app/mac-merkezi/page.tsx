...
export const metadata: Metadata = {
  title: 'Maç Merkezi',
  description: 'Şanlıurfaspor FK son maçlar, sonuçlar ve puan durumu — TFF 2. Lig Beyaz Grup.',
}
    ...
    <div className="min-h-screen bg-[#f5f9f6]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center justify-between gap-4 mb-8">
          <MatchTabs />
          <h2 className="hidden sm:block text-sm font-black tracking-widest uppercase text-[#7aab8e]">Son 5 Maç</h2>
        </div>
        <MacMerkezi all={matches} standings={standings} season={meta.season} logos={logoMap} limit={5} showFilter={false} />
      </div>
    </div>
  )
}
