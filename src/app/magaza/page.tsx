    ...
    <div className="min-h-screen bg-[#f5f9f6]">
      <div className="bg-[#0f4a28] py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-xs font-black tracking-widest uppercase text-[#FFD100]/60">Resmi Ürünler</p>
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">
            Kulüp <span className="text-[#FFD100]">Mağazası</span>
          </h1>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 pb-20">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {products.map((p) => (
            <div key={p.id} className="group bg-white rounded-2xl border border-[#ddeae2] shadow-sm overflow-hidden hover:shadow-lg hover:border-[#1A6B3C]/30 transition-all hover:-translate-y-1 duration-300">
