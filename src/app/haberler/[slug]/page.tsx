      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 -mt-28 relative pb-16">
        ...
        <article className="bg-white rounded-2xl border border-[#ddeae2] shadow-lg overflow-hidden">
          <div className="p-6 md:p-10">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-[11px] font-black tracking-widest uppercase mb-5 bg-[#FFD100] text-[#092d18]">
              {catName}
            </span>
            <h1 className="text-3xl md:text-4xl font-black text-[#092d18] leading-tight tracking-tight mb-4">{item.title}</h1>
            ...
            <div className="text-[#092d18] leading-relaxed text-base whitespace-pre-line">{item.content}</div>
          </div>
        </article>
