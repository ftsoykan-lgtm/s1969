              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1.5 shrink-0">
                  <button onClick={() => handleSave(i)} disabled={busy !== null}
                    className="inline-flex items-center gap-1.5 bg-[#1A6B3C] hover:bg-[#0f4a28] disabled:opacity-60 text-white text-xs font-black px-3 py-2 rounded-lg transition-colors">
