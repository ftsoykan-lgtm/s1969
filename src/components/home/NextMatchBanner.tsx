...
/**
 * Sıradaki Maç bandı — hero'nun hemen altında, tam genişlikte AÇIK/KURUMSAL kart.
  ...
  return (
    <section className="relative bg-[#f8faf9] pt-10 md:pt-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-[#e6efe9] bg-white p-6 shadow-[0_28px_64px_-32px_rgba(12,46,34,0.28)] md:p-9">
          ...
          <div className="relative mb-6 flex items-center justify-between gap-3">
            ...
            <span className="hidden text-[11px] font-extrabold uppercase tracking-wide text-[#93a89e] sm:block">{meta.league}</span>
          </div>
