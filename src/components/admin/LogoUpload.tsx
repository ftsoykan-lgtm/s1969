  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-1.5">
        <label className="text-xs font-black text-[#3d6b52] uppercase tracking-wide">{label}</label>
        <button type="button" onClick={() => setManual(!manual)}
          className="text-[10px] font-bold text-[#7aab8e] hover:text-[#1A6B3C] flex items-center gap-1">
          ...
          {manual ? (
            ...
            <>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-[#1A6B3C] hover:bg-[#0f4a28] disabled:opacity-60 text-white text-sm font-bold px-4 py-2.5 rounded-xl transition-colors"
              >
